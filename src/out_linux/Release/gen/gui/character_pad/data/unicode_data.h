...
static const size_t kUnicodeDataSize = 23357;
static const UnicodeData kUnicodeData[] = {
  { 0, "NULL" },
  { 1, "START OF HEADING" },
  { 2, "START OF TEXT" },
  { 3, "END OF TEXT" },
  ...
  { 173782, "<CJK Ideograph Extension B, Last>" },
  { 173824, "<CJK Ideograph Extension C, First>" },
  { 177972, "<CJK Ideograph Extension C, Last>" },
