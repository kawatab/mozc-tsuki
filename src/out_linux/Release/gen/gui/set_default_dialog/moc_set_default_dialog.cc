...
void mozc::gui::SetDefaultDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SetDefaultDialog *_t = static_cast<SetDefaultDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mozc::gui::SetDefaultDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_mozc__gui__SetDefaultDialog.data,
      qt_meta_data_mozc__gui__SetDefaultDialog,  qt_static_metacall, nullptr, nullptr}
};
